    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.emptyState}>
           ...
           <Text style={styles.emptyDesc}>Explore our catalog and save your favorite items here.</Text>
...
const styles = StyleSheet.create({
  ...
  emptyDesc: { fontSize: 14, fontFamily: FontFamily.medium, color: theme.onSurfaceVariant, textAlign: 'center', marginBottom: 25 },
  primaryBtn: { flexDirection: 'row', backgroundColor: theme.primary, paddingVertical: 14, paddingHorizontal: 35, borderRadius: 25, alignItems: 'center' },
